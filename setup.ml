...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5f515f197d0edfa75ca4d62dc180dc8d) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "roaring_bindgen.ml"});
               Library
                 ({
                     cs_name = "roaring";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_tools =
                        [
                           ...
                           ExternalTool "ocamlbuild";
                           InternalExecutable "roaring_bindgen"
                        ];
                      bs_c_sources =
                        [
                           "roaring_stubs.c";
                           "CRoaring/include/containers/bitset.h";
                        ...
                        [
                           (OASISExpr.EBool true,
                             [
                                ...
                                "${pkg_ctypes_stubs}";
                                "-I";
                                "lib/CRoaring/include/containers";
                                "-std=c99";
                                "-O3";
                                "-mavx2"
                             ])
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["Roaring_bindings"; "Roaring_generated"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "roaring";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "roaring"];
                      bs_build_tools =
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "bench_roaring.ml"})
            ];
          plugins =
            [
               (`Extra, "META", Some "0.4");
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\207\135\189W\252P;\236-]E#M\198\016d";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
